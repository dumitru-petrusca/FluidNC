...
static Error lock_x(const char* value, AuthenticationLevel auth_level, Channel& out) {
    return toggle_lock(X_AXIS);
}
static Error lock_y(const char* value, AuthenticationLevel auth_level, Channel& out) {
    return toggle_lock(Y_AXIS);
}
static Error lock_z(const char* value, AuthenticationLevel auth_level, Channel& out) {
    return toggle_lock(Z_AXIS);
}
static Error lock_a(const char* value, AuthenticationLevel auth_level, Channel& out) {
    return toggle_lock(A_AXIS);
}
static Error lock_b(const char* value, AuthenticationLevel auth_level, Channel& out) {
    return toggle_lock(B_AXIS);
}
static Error lock_c(const char* value, AuthenticationLevel auth_level, Channel& out) {
